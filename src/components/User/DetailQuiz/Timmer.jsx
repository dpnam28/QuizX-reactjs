...
const Timmer = ({ listQuestions, finishQuiz }) => {
        ...
        {!_.isEmpty(listQuestions) &&
          listQuestions.map((item, index) => (
            <div
              ...
              className="border rounded-full size-10 flex justify-center items-center hover:scale-105 duration-300 transition-all cursor-pointer hover:border-gray-500"
            >
              {index + 1}
            </div>
          ))}
